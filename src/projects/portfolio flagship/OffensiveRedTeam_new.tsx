...
export const OffensiveRedTeam: React.FC<{ onBack?: () => void }> = ({
  onBack,
}) => {
  const [view, setView] = React.useState<
    "overview" | "lab" | "webapp" | "report"
  >("overview");
    ...
    <div style={containerStyle}>
      ...
      <header style={headerStyle}>
        ...
        <div style={titleSectionStyle}>
          ...
          <p style={subtitleStyle}>
            {">"} MISSION: EXPLOIT_SYSTEMS | DOCUMENT_VULNS |
      ...
      <footer style={footerStyle}>
        <div style={warningStyle}>
          ⚠️ EDUCATIONAL_USE_ONLY | AUTHORIZED_TESTING_REQUIRED |
...
const VulnLab: React.FC = () => {
  ...
  const [attackChain, setAttackChain] = React.useState<AttackStep[]>([
    { phase: "RECON", detail: "nmap -sC -sV -p- 10.10.0.42", risk: "LOW" },
    {
      ...
      detail: "CMS upload bypass -> webshell",
      risk: "HIGH",
    },
  ]);
        ...
        <div style={panelStyle}>
          ...
          <div style={panelContentStyle}>
            <div style={stepStyle}>
              ...
              <span>
                Import vulnerable VM (VulnHub/THM) to isolated network
              </span>
            </div>
            <div style={stepStyle}>
            ...
            <div style={zapResultStyle}>
              <label style={zapLabelStyle}>
                ...
                <input
                  ...
                  value={zapBefore}
                  onChange={(e) =>
                    setZapBefore(e.target.value ? Number(e.target.value) : "")
                  }
                  style={zapInputStyle}
                  min={0}
                />
              ...
              <label style={zapLabelStyle}>
                ...
                <input
                  ...
                  value={zapAfter}
                  onChange={(e) =>
                    setZapAfter(e.target.value ? Number(e.target.value) : "")
                  }
                  style={zapInputStyle}
                  min={0}
                />
...
const AttackChainEditor: React.FC<AttackChainEditorProps> = ({
  ...
  const addStep = () => {
    onChange([
      ...steps,
      { phase: "NEW_PHASE", detail: "Enter attack details", risk: "MEDIUM" },
    ]);
  };

  const updateStep = (
    index: number,
    field: keyof AttackStep,
    value: string
  ) => {
  ...
  <div style={objectiveCardStyle}>
    ...
    <div style={objectiveDetailsStyle}>
      {details.map((detail, index) => (
        <div key={index} style={objectiveDetailStyle}>
          • {detail}
        </div>
      ))}
    </div>
    <div style={objectiveToolsStyle}>
      ...
      {tools.map((tool, index) => (
        <span key={index} style={toolBadgeStyle}>
          {tool}
        </span>
      ))}
    </div>
